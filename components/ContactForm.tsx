...
import userCreateInquiryMutation from "@/hooks/use-create-inquiry-mutation";
...
export default function ContactForm() {
  ...
  const createInquiryMutation = userCreateInquiryMutation();
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await createInquiryMutation.mutateAsync(form);
