...
//         active
//           ? "border-blue-400/80 bg-blue-500/10 shadow-[0_0_24px_rgba(59,130,246,0.45)]"
//           : "opacity-70",
//       ].join(" ")}
...
function Line() {
  return (
    <div className="w-[1px] h-[20px] bg-slate-500 rounded-full my-2"></div>
  );
}
  ...
  return (
    <div
      className={[
        ...
        "flex flex-col items-center gap-2 max-w-[680px] pt-2 pb-3 px-10 text-xs font-medium leading-[1.5] bg-[rgba(30,41,59,0.5)]",
        active
